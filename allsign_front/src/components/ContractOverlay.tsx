...
const ContractOverlay: React.FC<ContractOverlayProps> = ({ isOpen, onClose, client, onSuccess, contract, isViewOnly }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 p-0 md:p-4 backdrop-blur-sm overflow-y-auto print:static print:bg-white print:p-0">
      <div className="relative w-full max-w-7xl rounded-xl bg-white shadow-2xl dark:bg-zinc-900 my-0 md:my-8 flex flex-col h-full md:h-auto max-h-screen print:shadow-none print:my-0 print:h-auto print:max-h-none">
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Navigation Sidebar */}
          <div className="w-64 bg-gray-50 dark:bg-zinc-800/30 border-r border-gray-100 dark:border-zinc-800 overflow-y-auto p-6 hidden lg:block print:hidden shrink-0">
            <h3 className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-6">Navegação Rápida</h3>
            <nav className="space-y-8">
              {navGroups.map((group, idx) => (
                <div key={idx} className="space-y-3">
                  <h4 className="text-[10px] font-bold text-blue-500 dark:text-blue-400 uppercase">{group.title}</h4>
                    ...
                    {group.items.map((item) => (
                      <li key={item.id}>
                        <button
                          ...
                          className="text-[13px] text-gray-600 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-white hover:translate-x-1 transition-all duration-200 text-left w-full py-1"
                        >
                          {item.label}
                        </button>
                      </li>
            ...
            <div className="mt-10 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/50">
              <p className="text-[11px] text-blue-700 dark:text-blue-300 leading-relaxed font-medium">
                Dica: Clique em qualquer item acima para ir direto ao campo no documento.
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-10 bg-zinc-100 dark:bg-zinc-950 print:bg-white print:p-0 print:overflow-visible">
            <form id="contract-form" onSubmit={handleSubmit}>
              <div id="contract-paper" className="bg-white text-zinc-900 p-8 md:p-20 shadow-2xl border border-zinc-200 rounded-sm font-serif leading-relaxed text-[12px] md:text-[14px] print:shadow-none print:border-none print:p-0 mx-auto max-w-[210mm] print:max-w-none">
                ...
                {/* PÁGINA 2 */}
                <section id="section-resumo" className="mb-10 break-inside-avoid scroll-mt-24">
                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        <tr className="border-b border-zinc-400">
                          ...
                          <td className="p-3">
                            <div className="flex items-center gap-2 font-bold">● R$ <input id="field-service-value" type="text" readOnly={isViewOnly} className={inputClass("bg-yellow-100 border-b border-yellow-400 outline-none px-2 w-40 font-bold scroll-mt-24")} value={formData.service_value} onChange={e => setFormData({...formData, service_value: e.target.value})}/></div>
                          </td>
                        </tr>
                        <tr className="border-b border-zinc-400">
                          ...
                          <td className="p-3">
                            <div className="flex items-center gap-2 font-bold">● R$ <input id="field-equipment-value" type="text" readOnly={isViewOnly} className={inputClass("bg-yellow-100 border-b border-yellow-400 outline-none px-2 w-40 font-bold scroll-mt-24")} value={formData.equipment_value} onChange={e => setFormData({...formData, equipment_value: e.target.value})}/></div>
                          </td>
                        </tr>
                        <tr className="border-b border-zinc-400">
                        ...
                        <tr id="section-equipamentos" className="border-b border-zinc-400 scroll-mt-24">
                        ...
                        <tr className="border-b border-zinc-400">
                          ...
                          <td className="p-3 font-bold uppercase">
                             ● <input id="field-due-date" type="text" readOnly={isViewOnly} className={inputClass("bg-yellow-100 w-full scroll-mt-24")} value={formData.due_date} onChange={e => setFormData({...formData, due_date: e.target.value})}/>
                          </td>
                        </tr>
                        <tr className="border-b border-zinc-400">
                          <td className="p-3 border-r border-zinc-400 font-bold uppercase">FORMA DE PAGAMENTO</td>
                          <td className="p-3 uppercase font-bold">
                             ● <textarea id="field-payment-method" readOnly={isViewOnly} className={inputClass("bg-yellow-100 w-full outline-none h-16 resize-none scroll-mt-24")} value={formData.payment_method} onChange={e => setFormData({...formData, payment_method: e.target.value})} />
                          </td>
                        </tr>
                        <tr>
                          <td className="p-3 border-r border-zinc-400 font-bold uppercase">UNIDADES BENEFICIARIAS</td>
                          <td className="p-3 font-bold uppercase">
                            ● <input id="field-beneficiary" type="text" readOnly={isViewOnly} className={inputClass("bg-yellow-100 w-full scroll-mt-24")} value={formData.beneficiary_units} onChange={e => setFormData({...formData, beneficiary_units: e.target.value})}/>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <section id="section-clausulas" className="space-y-8 text-justify leading-relaxed scroll-mt-24">
                  ...
                  {/* CLÁUSULA 4 */}
                  <div id="field-payment-clause" className="scroll-mt-24">
                ...
                <div id="section-assinaturas" className="mt-24 text-right uppercase font-bold pb-10 scroll-mt-24">
