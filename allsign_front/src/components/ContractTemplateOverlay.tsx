...
const ContractTemplateOverlay: React.FC<ContractTemplateOverlayProps> = ({ isOpen, onClose, onSuccess, initialData }) => {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 md:pl-72 overflow-y-auto">
      <div className="bg-white w-full max-w-6xl rounded-2xl shadow-2xl flex flex-col h-full max-h-[95vh]">
        ...
        <div className="flex-1 overflow-y-auto bg-gray-100/50 p-4 md:p-8">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-100 p-4 rounded-2xl flex items-center gap-4">
                ...
                <div>
                    <p className="text-sm font-bold text-blue-800">Dica Pro: Use chaves duplas para campos dinâmicos.</p>
                    <p className="text-xs text-blue-600 opacity-80">Exemplo: "Eu, {"{{ nome_cliente }}"}, portador do CPF {"{{ cpf_cliente }}"}..."</p>
                </div>
            </div>
